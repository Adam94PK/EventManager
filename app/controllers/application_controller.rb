class ApplicationController < ActionController::Base
  ...
  def configure_permitted_parameters
  	...
  	devise_parameter_sanitizer.for(:account_update) { |u| u.permit(:email, :user_name, :role, :password, :name, :surname, :company_name, :current_password, :avatar, :description, :profile_access) }
  end
